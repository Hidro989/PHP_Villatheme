    ...
    class Pagination{
        ...
        function html(){
            ...
            if($this->_config['total_record'] > $this->_config['limit']){
                ...
                if($this->_config['current_page'] > 1){
                    $p .= '<li><a href="'.$this->__link($this->_config['current_page']-1).'"><i class=\'bx bx-left-arrow-alt\'></i></a></li>';
                }
                ...
                if($this->_config['current_page'] < $this->_config['total_page']){
                    $p .= '<li><a href="'.$this->__link($this->_config['current_page'] + 1).'"><i class=\'bx bx-right-arrow-alt\'></i></a></li>';
                }
